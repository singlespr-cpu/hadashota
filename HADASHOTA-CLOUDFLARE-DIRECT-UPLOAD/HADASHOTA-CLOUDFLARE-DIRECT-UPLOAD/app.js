const KOTERET_CLIENT_BUILD = "129.0.0";
...
async function verifyApiVersion() {
  ...
  try {
    ...
    marker.textContent = apiVersion ? `גרסה V129 · API ${apiVersion}` : "גרסה V129 · API לא מזוהה";
  } catch (error) {
    marker.textContent = "גרסה V129 · API לא מחובר";
...
async function registerServiceWorker() {
  ...
  try {
    state.serviceWorkerRegistration = await navigator.serviceWorker.register("/sw.js?v=129.0.0", { updateViaCache: "none" });
