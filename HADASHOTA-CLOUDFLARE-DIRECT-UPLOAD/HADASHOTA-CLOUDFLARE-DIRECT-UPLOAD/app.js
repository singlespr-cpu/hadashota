const KOTERET_CLIENT_BUILD = "133.0.0";
...
async function verifyApiVersion() {
  ...
  try {
    ...
    marker.textContent = apiVersion ? `גרסה V133 · API ${apiVersion}` : "גרסה V133 · API לא מזוהה";
  } catch (error) {
    marker.textContent = "גרסה V133 · API לא מחובר";
...
async function registerServiceWorker() {
  ...
  try {
    state.serviceWorkerRegistration = await navigator.serviceWorker.register("/sw.js?v=133.0.0", { updateViaCache: "none" });
