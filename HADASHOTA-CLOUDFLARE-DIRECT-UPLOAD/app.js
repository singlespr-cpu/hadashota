const KOTERET_CLIENT_BUILD = "134.0.0";
...
async function verifyApiVersion() {
  ...
  try {
    ...
    marker.textContent = apiVersion ? `גרסה V134 · API ${apiVersion}` : "גרסה V134 · API לא מזוהה";
  } catch (error) {
    marker.textContent = "גרסה V134 · API לא מחובר";
...
async function registerServiceWorker() {
  ...
  try {
    state.serviceWorkerRegistration = await navigator.serviceWorker.register("/sw.js?v=134.0.0", { updateViaCache: "none" });
