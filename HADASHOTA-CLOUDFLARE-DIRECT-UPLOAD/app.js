const KOTERET_CLIENT_BUILD = "132.0.0";
...
async function verifyApiVersion() {
  ...
  try {
    ...
    marker.textContent = apiVersion ? `גרסה V132 · API ${apiVersion}` : "גרסה V132 · API לא מזוהה";
  } catch (error) {
    marker.textContent = "גרסה V132 · API לא מחובר";
...
async function registerServiceWorker() {
  ...
  try {
    state.serviceWorkerRegistration = await navigator.serviceWorker.register("/sw.js?v=132.0.0", { updateViaCache: "none" });
