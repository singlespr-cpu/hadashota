# חדשותא — HADASHOTA FINAL V13 LAUNCH

גרסת production סופית לפריסה ב-Cloudflare Workers + Static Assets.

## עיקרי V13

- היררכיה חדשותית חזקה יותר: הכותרת המרכזית, הכותרות האדומות ו"האחרונים עכשיו" גדולים וברורים יותר.
...
- cache-busting לגרסת 13 כדי למנוע מצב שבו דפדפן ממשיך להריץ app.js/styles.css ישנים אחרי Deploy.
...
- `styles.css` — Desktop/Mobile/Dark Mode ועיצוב V13.
